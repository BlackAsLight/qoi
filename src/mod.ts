 ...
 * `ReadableStream<Uint8Array>` in the desired format. The raw pixel format
 * pipped into the encoder is expected to be a repeating sequence of
 * `[ r, g, b, a ]`. This is also the format that is pipped out of the decoder.
